...
import { Calendar, Smile, Home, Bell, LogOut, RefreshCw } from 'lucide-react';
  ...
  return (
    <>
      <div className="flex flex-col min-h-screen bg-cream-100">
        ...
        <nav className="sticky bottom-0 bg-white/80 backdrop-blur-md border-t border-cream-200 pb-safe z-40">
      ...
      <SyncCodeModal isOpen={showSync} onClose={() => setShowSync(false)} />
    </>
  );
}
